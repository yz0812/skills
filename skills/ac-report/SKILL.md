---
name: ac-report
description: '基于 Git 提交记录生成周报或月报。'
...
```
"/ac-report 生成本周周报"       → 类型=周报, 用户=当前, 日期=本周
"/ac-report 生成12月月报"       → 类型=月报, 用户=当前, 日期=12月
"/ac-report 生成周报 @张三"     → 类型=周报, 用户=张三, 日期=本周
"/ac-report 生成最近10天的周报" → 类型=周报, 用户=当前, 日期=最近10天
```
...
读取 `assets/templates/weekly.md` 或 `assets/templates/monthly.md`，替换变量：
